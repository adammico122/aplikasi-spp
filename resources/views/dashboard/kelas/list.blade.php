    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Data Kelas</h5>
                            <span>Anda Telah Mengakses Halaman Biodata Kelas</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <a href="javascript:void(0)" class="btn btn-pill btn-primary" id="tombol-tambah">Tambah Kelas</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="konfirmasi-modal" data-backdrop="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Data Kelas Yang Dipilih Akan Dihapus Secara Permanent, Anda yakin?</p>
            </div>
...
@section('script')
    ...
    // Composer require yajra/laravel-datatables-oracle:"~9.0" //
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#id_kelas').val(''); //valuenya menjadi kosong
        ...
        $(document).ready(function() {
           $('#table_kelas').DataTable({ // #table_guru Adalah Nama ID Dari Table ID. Apabila Anda Menggunakan Class Maka Gunakan . Bukan #
                processing : true,
                ...
                columns: [ // Semua Data Columns Diambil Dari guruModel:: Dari guruController.
                    {data:'nama_kelas',name:'nama_kelas'}, // [0]
            ...
            $("#form-save").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('add.kelas') }}", // url simpan data
                        ...
                        success: function (data) { // jika berhasil 
                            ...
                            iziToast.success({ // tampilkan iziToast dengan notif data berhasil disimpan pada posisi kanan bawah
                                title: 'Data Kelas Baru Berhasil Ditambahkan!',
                                message: '{{ Session('
                                success ')}}',
        ...
        $('body').on('click', '.edit-post', function () {
            var data_id_kelas = $(this).data('id');
            $.get('kelas/' + data_id_kelas + '/edit', function (data) {
        ...
        $('#delete-button').click(function () {
            $.ajax({
                url: "kelas/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_kelas').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
