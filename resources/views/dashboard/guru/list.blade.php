    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Data Guru</h5>
                            <span>Anda Telah Mengakses Halaman Biodata Guru</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <a href="javascript:void(0)" class="btn btn-pill btn-primary" id="tombol-tambah">Tambah Guru</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Nama Guru</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="no_tlpn" name="no_tlpn" value=""
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Lulusan</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="universitas" id="universitas" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Kewarganegaraan</label>
                                <div class="col-sm-12">
...
<div class="modal fade" tabindex="-1" role="dialog" id="konfirmasi-modal" data-backdrop="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Data Guru Yang Dipilih Akan Dihapus Secara Permanent, Anda yakin?</p>
            </div>
...
@section('script')
    ...
    // Composer require yajra/laravel-datatables-oracle:"~9.0" //
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#id_guru').val(''); //valuenya menjadi kosong
            $('#form-save').trigger("reset"); //mereset semua input dll didalamnya
            $('#modal-judul').html("Form Tambah Data guru"); //valuenya tambah guru baru
            $('#tambah-edit-modal').modal('show'); //modal tampil
        });

        // Datatable Table guru - AJAX Jquery
        $(document).ready(function() {
           $('#table_guru').DataTable({ // #table_guru Adalah Nama ID Dari Table ID. Apabila Anda Menggunakan Class Maka Gunakan . Bukan #
                processing : true,
                ...
                columns: [ // Semua Data Columns Diambil Dari guruModel:: Dari guruController.
                    {data:'nama_guru',name:'nama_guru'}, // [0]
                    {data:'no_tlpn',name:'no_tlpn'}, // [1]
                    {data:'jenis_kelamin',name:'jenis_kelamin'}, // [2]
                    {data:'agama',name:'agama'}, // [3]
                    {data:'alamat',name:'alamat'}, // [4]
            ...
            $("#form-save").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('add.guru') }}", // url simpan data
                        ...
                        success: function (data) { // jika berhasil 
                            ...
                            var oTable = $('#table_guru').dataTable(); // inialisasi datatable
                            oTable.fnDraw(false); // reset datatable
                            iziToast.success({ // tampilkan iziToast dengan notif data berhasil disimpan pada posisi kanan bawah
                                title: 'Data guru Baru Berhasil Ditambahkan!',
                                message: '{{ Session('
                                success ')}}',
        ...
        $('body').on('click', '.edit-post', function () {
            var data_id_guru = $(this).data('id_guru');
            $.get('guru/' + data_id_guru + '/edit', function (data) {
        ...
        $('#delete-button').click(function () {
            $.ajax({
                url: "guru/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
